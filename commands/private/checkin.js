...
//         .setName('checkin')
//         .setDescription("Don't use this command, it's outdated"),
//     async execute(interaction) {
//         await interaction.reply(`This command is outdated. idk why someone executed it but please go clown on them`);
//     },
// };
